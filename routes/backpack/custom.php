...
Route::group([
    ...
    Route::crud('shader-category', 'ShaderCategoryCrudController');
    Route::crud('shader-subcategory', 'ShaderSubcategoryCrudController');
    Route::crud('shader-author', 'ShaderAuthorCrudController');
